...
public class SummaSearcherAggregatorTest extends TestCase {
    ...
    public void testMultiple() throws Exception {
        ...
        for (String shard: SHARDS) {
            ...
            assertTrue("Searcher for shard '" + shard + "' should work. Got result " + result,
    ...
    public void testAggregator() throws IOException {
        ...
        String[] actual = result.substring(result.lastIndexOf("<ids>") + 5, result.lastIndexOf("</ids>")).split(", ");
        Arrays.sort(actual);
    ...
    private void closeSearchers(List<SummaSearcher> searchers) throws IOException {
    ...
    private SummaSearcher createSearcher(String id) throws IOException {
        Configuration conf = Configuration.newMemoryBased();
        conf.set(RMISearcherProxy.CONF_BACKEND, SummaSearcherDummy.class.getCanonicalName());
