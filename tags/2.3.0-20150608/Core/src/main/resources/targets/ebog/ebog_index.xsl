...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="ebog_short_format.xsl" />
    <xsl:include href="ebog_author.xsl" />
    <xsl:include href="ebog_title.xsl" />
    <xsl:include href="ebog_subject.xsl" />
    <xsl:include href="ebog_publisher.xsl" />
    <xsl:include href="ebog_other.xsl" />
    <xsl:include href="ebog_notes.xsl" />
    <xsl:include href="ebog_relations.xsl" />
    <xsl:include href="ebog_classification.xsl" />
    <xsl:include href="ebog_identificers.xsl" />
    <xsl:include href="ebog_material.xsl" />
    <xsl:include href="ebog_lcl.xsl" />
    <xsl:include href="ebog_lma.xsl" />
