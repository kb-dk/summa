...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="dkb_short_format.xsl" />
    <xsl:include href="dkb_author.xsl" />
    <xsl:include href="dkb_title.xsl" />
    <xsl:include href="dkb_subject.xsl" />
    <xsl:include href="dkb_publisher.xsl" />
    <xsl:include href="dkb_other.xsl" />
    <xsl:include href="dkb_notes.xsl" />
    <xsl:include href="dkb_identifiers.xsl" />
    <xsl:include href="dkb_material.xsl" />
    <xsl:include href="dkb_lma.xsl" />
    ...
    <xsl:template match="/">
        ...
        <Index:document Index:defaultBoost="1" Index:defaultType="token" Index:defaultFreetext="true" Index:defaultSuggest="false"
                        Index:defaultGroup="false" Index:langAutogroup="true" Index:resolver="dkb">
            <xsl:attribute name="Index:id">
                <xsl:text>dkb_</xsl:text>
