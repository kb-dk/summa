...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="identifiers">
        <Index:group Index:name="numbers" Index:navn="nr">
            ...
            <xsl:for-each select="mc:datafield[@tag='520']/mc:subfield[@code='z' or @code='r']">
                <Index:field Index:name="standard_number" Index:navn="is" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="translate(.,'- ','')"/>
                </Index:field>
            </xsl:for-each>
            ...
            <xsl:for-each select="mc:datafield[@tag='526']/mc:subfield[@code='z' or @code='r']">
                <Index:field Index:name="standard_number" Index:navn="is" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="translate(.,'- ','')"/>
                </Index:field>
            </xsl:for-each>
            ...
            <xsl:for-each select="mc:datafield[@tag='520']/mc:subfield[@code='z']">
                <Index:field Index:name="issn" Index:navn="in" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="."/>
                </Index:field>
            </xsl:for-each>
            <xsl:for-each select="mc:datafield[@tag='526']/mc:subfield[@code='z']">
                <Index:field Index:name="issn" Index:navn="in" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="."/>
                </Index:field>
            </xsl:for-each>
            ...
            <xsl:for-each select="mc:datafield[@tag='021']/mc:subfield[@code='a' or @code='e']">
             ...
             <xsl:for-each select="mc:datafield[@tag='520']/mc:subfield[@code='r']">
                <Index:field Index:name="isbn" Index:navn="ib" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="java:dk.statsbiblioteket.summa.plugins.ISBN.isbnNorm(.)"/>
                </Index:field>
            </xsl:for-each>
            ...
            <xsl:for-each select="mc:datafield[@tag='025']/mc:subfield[@code='a']">
                <Index:field Index:name="standard_number" Index:navn="is" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="java:dk.statsbiblioteket.summa.plugins.Normalize.normalize(.)"/>
                </Index:field>
            </xsl:for-each>
            ...
            <xsl:for-each select="mc:datafield[@tag='994']">
                <Index:field Index:repeat="true" Index:name="id" Index:navn="id" Index:type="number" Index:boostFactor="10">
                    <xsl:choose>
                        <xsl:when test="mc:subfield[@code='z']">
                            <xsl:value-of select="mc:subfield[@code='z']"/>
                        </xsl:when>
                        <xsl:when test="mc:subfield[@code='a']">
                            <xsl:value-of select="mc:subfield[@code='a']"/>
                        </xsl:when>
                    </xsl:choose>
                </Index:field>
            </xsl:for-each>
            <xsl:for-each select="mc:datafield[@tag='247' or @tag='248']/mc:subfield[@code='9']">
                <Index:field Index:repeat="true" Index:name="id" Index:navn="id" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="."/>
                </Index:field>
            </xsl:for-each>
            <xsl:for-each select="mc:datafield[@tag='024' or @tag='027' or @tag='028']/mc:subfield[@code='a' or @code='x']">
                <Index:field Index:repeat="true" Index:name="standard_number" Index:navn="is" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="."/>
                </Index:field>
            </xsl:for-each>
            <xsl:for-each select="mc:datafield[@tag='245']/mc:subfield[@code='z' ]">
                <Index:field Index:repeat="true" Index:name="standard_number" Index:navn="is" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="."/>
                </Index:field>
            </xsl:for-each>
            <xsl:for-each select="mc:datafield[@tag='024' or @tag='027' or @tag='028' or @tag='030']/mc:subfield[@code='a' or @code='x']">
                <Index:field Index:repeat="true" Index:name="number" Index:navn="nummer" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="java:dk.statsbiblioteket.summa.plugins.Normalize.normalize(.)"/>
                </Index:field>
            </xsl:for-each>
            <xsl:for-each select="mc:datafield[@tag='010']/mc:subfield[@code='a']">
                <Index:field Index:repeat="true" Index:name="number" Index:navn="nummer" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="translate(.,'- ','')"/>
                </Index:field>
            </xsl:for-each>
            ...
            <xsl:for-each select="mc:datafield[@tag='020']/mc:subfield[@code='a' or @code='b' or @code='x']">
                <Index:field Index:repeat="true" Index:name="number" Index:navn="nummer" Index:type="number" Index:boostFactor="10">
                    <xsl:value-of select="."/>
                </Index:field>
            </xsl:for-each>
