...
public class SummaStandardAnalyzerTest extends AnalyzerTestCase {
    ...
    public final void testFooCaseFold() throws Exception {
        assertAnalyzer(new SummaStandardAnalyzer(), "Foo",
                       "foo");
    }

    public final void testFooBarCaseFold() throws Exception {
        assertAnalyzer(new SummaStandardAnalyzer(), "Foo baR",
                       "foo", "bar");
    }

    public final void testWhiteSpace1() throws Exception {
        assertAnalyzer(new SummaStandardAnalyzer(), " white ",
                       "white");
    }

    public final void testWhiteSpace2() throws Exception {
        assertAnalyzer(new SummaStandardAnalyzer(), "barry   white ",
                       "barry", "white");
    }

    public final void testWhiteSpace3() throws Exception {
        assertAnalyzer(new SummaStandardAnalyzer(), " I  P Jacobsen    ",
                       "i", "p", "jacobsen");
    }
    ...
    public final void testTokenReplacements() throws Exception {
        assertAnalyzer(new SummaStandardAnalyzer(), ".Net vs C* Algebra?",
                       "dotnet", "vs", "cstaralgebra");
    }

    public final void testDashes() throws Exception {
        assertAnalyzer(new SummaStandardAnalyzer(), "Hr. A. Binde-Streg",
                       "hr", "a", "binde", "streg");
        assertAnalyzer(new SummaStandardAnalyzer(), "Jan-Hendrik S. Hofmeyr",
