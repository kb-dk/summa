...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="dub_short_format.xsl" />
    <xsl:include href="dub_author.xsl" />
    <xsl:include href="dub_title.xsl" />
    <xsl:include href="dub_subject.xsl" />
    <xsl:include href="dub_publisher.xsl" />
    <xsl:include href="dub_other.xsl" />
    <xsl:include href="dub_notes.xsl" />
    <xsl:include href="dub_identifiers.xsl" />
    <xsl:include href="dub_material.xsl" />
    <xsl:include href="dub_lma.xsl" />
    <xsl:include href="dub_classification.xsl" />
    ...
    <xsl:template match="/">
        ...
        <Index:document Index:defaultBoost="1" Index:defaultType="token" Index:defaultFreetext="true" Index:defaultSuggest="false"
                        Index:defaultGroup="false" Index:langAutogroup="true" Index:resolver="dub">
            <xsl:attribute name="Index:id">
                <xsl:text>dub_</xsl:text>
                        ...
                        <xsl:choose>
                            <xsl:when test="contains(mc:subfield[@type='u'],'?')">
                                <Index:field Index:name="py" Index:navn="år" Index:type="token" Index:boostFactor="10">
                                    <xsl:value-of select="java:dk.statsbiblioteket.sbandex.plugins.YearRange.makeRange(mc:subfield[@type='a'], mc:subfield[@type='z'])"/>
                                </Index:field>
                            </xsl:when>
                            <xsl:when test="contains(mc:subfield[@type='u'],'o')">
                                <Index:field Index:name="py" Index:navn="år" Index:type="token" Index:boostFactor="10">
                                    <xsl:value-of select="java:dk.statsbiblioteket.sbandex.plugins.YearRange.makeRange(mc:subfield[@type='a'],'2030')"/>
                                </Index:field>
                            </xsl:when>
