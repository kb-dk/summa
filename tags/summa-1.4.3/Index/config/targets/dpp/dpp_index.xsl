...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="dpp_short_format.xsl" />
    <xsl:include href="dpp_author.xsl" />
    <xsl:include href="dpp_title.xsl" />
    <xsl:include href="dpp_subject.xsl" />
    <xsl:include href="dpp_publisher.xsl" />
    <xsl:include href="dpp_other.xsl" />
    <xsl:include href="dpp_notes.xsl" />
    <xsl:include href="dpp_identifiers.xsl" />
    <xsl:include href="dpp_material.xsl" />
    <xsl:include href="dpp_lma.xsl" />
    ...
    <xsl:template match="/">
        ...
        <Index:document Index:defaultBoost="1" Index:defaultType="token" Index:defaultFreetext="true" Index:defaultSuggest="false"
                        Index:defaultGroup="false" Index:langAutogroup="true" Index:resolver="dpp">
            <xsl:attribute name="Index:id">
                <xsl:text>dpp_</xsl:text>
