...
@QAInfo(level = QAInfo.Level.NORMAL,
        ...
        author = "te",
        comment = "Scheduled for deprecation as ISO2709ToMARCXMLFilter does the job itself")
public class MARC21SlimTweaker extends ObjectFilterImpl {
     ...
     */
    public static final String CONF_CONTROLFIELDS = "summa.marctweaker.controlfields";
     ...
     */
    public static final String CONF_SUBFIELD_FIX = "summa.marctweaker.subfield.fix";
     ...
     */
    public static final String CONF_SUBFIELD_SEPARATOR = "summa.marctweaker.subfield.separator";
    ...
    protected boolean processPayload(Payload payload) throws PayloadException {
        if (payload.getStream() == null) {
            Logging.logProcess("MARC21SlimTweaker", "No Stream", Logging.LogLevel.DEBUG, payload);
            return true;
        }
        payload.setStream(new MARC21SlimTweakerStream(
                payload.getStream(), controlfields, subfieldFix, subfieldSeparator));
        return true;
    }
    ...
    public static class MARC21SlimTweakerStream extends InputStream {
        ...
        public MARC21SlimTweakerStream(InputStream source, Pattern controlfields, boolean subfieldFix,
