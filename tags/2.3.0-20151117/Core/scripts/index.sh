...
$JAVA_HOME/bin/java -jar $JAVA_OPTS -Dsun.rmi.transport.tcp.connectionPool=true -Djava.rmi.server.codebase=$CODE_BASE -Djava.security.policy=$SECURITY_POLICY $JMX_PORT $JMX_SSL $JMX_ACCESS $JMX_PASS summaIndex.jar &
