...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="subject">
							...
							<Index:field Index:repeat="true" Index:name="subject_controlled" Index:navn="ke" Index:type="token" Index:boostFactor="6">
								<xsl:choose>
									<xsl:when test="mc:subfield[@code='a']">
										...
										<xsl:if test="mc:subfield[@code='e']">
											<xsl:text> (</xsl:text>
											<xsl:value-of select="mc:subfield[@code='e']" />
											<xsl:text>)</xsl:text>
										</xsl:if>
										<xsl:if test="mc:subfield[@code='c']">
											<xsl:text>. </xsl:text>
										...
										<xsl:if test="mc:subfield[@code='i']">
											<xsl:text> ; </xsl:text>
											<xsl:value-of select="mc:subfield[@code='i']" />
										</xsl:if>
										<xsl:if test="mc:subfield[@code='k']">
											<xsl:text>, </xsl:text>
											<xsl:value-of select="mc:subfield[@code='k']" />
										</xsl:if>
										<xsl:if test="mc:subfield[@code='j']">
											<xsl:text>, </xsl:text>
											<xsl:value-of select="mc:subfield[@code='j']" />
										</xsl:if>
										<xsl:for-each select="mc:subfield[@code='t']">
											<xsl:text> : </xsl:text>
											<xsl:value-of select="."/>
									...
									<xsl:otherwise>
										<xsl:if test="mc:subfield[@code='s']">
											<xsl:value-of select="mc:subfield[@code='s']" />
											<xsl:if test="mc:subfield[@code='e']">
												<xsl:text> (</xsl:text>
												<xsl:value-of select="mc:subfield[@code='e']" />
												<xsl:text>)</xsl:text>
        ...
        <Index:group Index:defaultSuggest="true" Index:navn="lem" Index:name="lsubj">
						...
						<xsl:for-each select="mc:datafield[@tag='610']">
							<Index:field Index:repeat="false" Index:name="su_corp" Index:navn="lek" Index:type="keyword" Index:boostFactor="10">
								<xsl:choose>
									<xsl:when test="mc:subfield[@code='a']">
										 <xsl:choose>
                        <xsl:when test="contains(mc:subfield[@code='a'],'&lt;&lt;')">
                            <xsl:choose>
                            <xsl:when test="contains(mc:subfield[@code='a'],'&gt;&gt;')">
                             <xsl:choose>
                                 <xsl:when test="contains(mc:subfield[@code='a'],'=')">
                                   <xsl:value-of select="concat(substring-after(substring-before(mc:subfield[@code='a'],'='),'&lt;&lt;'),' ',substring-after(mc:subfield[@code='a'],'&gt;&gt;'))"/>
                                 </xsl:when>
                                 <xsl:otherwise>
                                 <xsl:value-of select="concat(substring-after(substring-before(mc:subfield[@code='a'],'&gt;&gt;'),'&lt;&lt;'),' ',substring-after(mc:subfield[@code='a'],'&gt;&gt;'))"/>
                               </xsl:otherwise>
                                 ...
                                 <xsl:otherwise>
                        <xsl:value-of select="substring-after(mc:subfield[@code='a'],'&lt;&lt;')"/>
                        </xsl:otherwise>
                            </xsl:choose>
                            </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="mc:subfield[@code='a']"/>
									...
									<xsl:otherwise>
										<xsl:if test="mc:subfield[@code='s']">
												 <xsl:choose>
                        <xsl:when test="contains(mc:subfield[@code='s'],'&lt;&lt;')">
                            <xsl:choose>
                            <xsl:when test="contains(mc:subfield[@code='s'],'&gt;&gt;')">
                             <xsl:choose>
                                 <xsl:when test="contains(mc:subfield[@code='s'],'=')">
                                   <xsl:value-of select="concat(substring-after(substring-before(mc:subfield[@code='s'],'='),'&lt;&lt;'),' ',substring-after(mc:subfield[@code='s'],'&gt;&gt;'))"/>
                                 </xsl:when>
                                 <xsl:otherwise>
                                 <xsl:value-of select="concat(substring-after(substring-before(mc:subfield[@code='s'],'&gt;&gt;'),'&lt;&lt;'),' ',substring-after(mc:subfield[@code='s'],'&gt;&gt;'))"/>
                               </xsl:otherwise>
                                 ...
                                 <xsl:otherwise>
                        <xsl:value-of select="substring-after(mc:subfield[@code='s'],'&lt;&lt;')"/>
                        </xsl:otherwise>
                            </xsl:choose>
                            </xsl:when>
                        <xsl:otherwise>
