								...
								<xsl:if test="contains(.,'a')">
										<xsl:choose>
												<xsl:when test="contains(/mc:record/mc:datafield[@tag='008']/mc:subfield[@code='t'],'m') or contains(/mc:record/mc:datafield[@tag='008']/mc:subfield[@code='t'],'s')">
                                                    ...
                                                    <xsl:choose>
																<xsl:when test="/mc:record/mc:datafield[@tag='009']/mc:subfield[@code='g' or @code='h']">
																	<xsl:choose>
																				<xsl:when test="contains(/mc:record/mc:datafield[@tag='009']/mc:subfield[@code='g' or @code='h'],'xx')">
																				...
																				<xsl:when test="contains(/mc:record/mc:datafield[@tag='009']/mc:subfield[@code='g' or @code='h'],'xa')">
																						<Index:field Index:repeat="false" Index:name="lma_long" Index:navn="lma_lang" Index:type="keyword">
																								<xsl:text>bog</xsl:text>
																						</Index:field>
																				</xsl:when>
