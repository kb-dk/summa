    ...
    <xsl:template name="title">
        <Index:group Index:name="ti" Index:navn="ti" >
                ...
                <xsl:for-each select="mc:datafield[@tag='245']/mc:subfield[@code='x']">
                    <Index:field Index:repeat="true" Index:name="title" Index:navn="titel" Index:type="token"   Index:suggest="true" Index:boostFactor="10">
                        <xsl:for-each select=".">
                            <xsl:value-of select="."/>
                        </xsl:for-each>
                    </Index:field>
                ...
                <xsl:for-each select="mc:datafield[@tag='247']/mc:subfield[@code='a']">
                    <Index:field Index:repeat="true" Index:name="main_titel" Index:navn="ht" Index:type="token"   Index:suggest="true" Index:boostFactor="10">
                        <xsl:for-each select=".">
                            <xsl:value-of select="."/>
                        </xsl:for-each>
                    </Index:field>
                ...
                <xsl:for-each select="mc:datafield[@tag='248']/mc:subfield[@code='a']">
                    <Index:field Index:repeat="true" Index:name="main_titel" Index:navn="ht" Index:suggest="true" Index:type="token" Index:boostFactor="10">
                        <xsl:for-each select=".">
                            <xsl:value-of select="."/>
                        </xsl:for-each>
                    </Index:field>
                ...
                <xsl:for-each select="mc:datafield[@tag='239']/mc:subfield[@code='t' or @code='u']">
                    ...
                    <Index:field Index:repeat="true" Index:name="title" Index:navn="titel" Index:type="token"  Index:suggest="true" Index:boostFactor="8">
                ...
                <xsl:for-each select="mc:datafield[@tag='240']">
                    <xsl:if test="mc:subfield[@code='a' or @code='d' or @code='e' or @code='f' or @code='g' or @code='h' or @code='j' or @code='k' or @code='s' or @code='4' or @code='r' or @code='q' or @code='u']">
                        <Index:field Index:repeat="true" Index:name="title" Index:navn="titel" Index:type="token"  Index:suggest="true" Index:boostFactor="8">
                ...
                <xsl:for-each select="mc:datafield[@tag='739']/mc:subfield[@code='t' or @code='4' or @code='v' or @code='u']">
                ...
                <xsl:for-each select="mc:datafield[@tag='795']/mc:subfield[@code='3' or @code='4' or @code='c' or @code='r' or @code ='s']">
                    <Index:field Index:repeat="true" Index:name="title" Index:navn="titel" Index:type="token" Index:boostFactor="4">
                        <xsl:value-of select="."/>
                    </Index:field>
                </xsl:for-each>
                ...
                <xsl:for-each select="mc:datafield[@tag='700']/mc:subfield[@code='t']">
                    <Index:field Index:repeat="true" Index:name="title" Index:navn="titel" Index:type="token" Index:boostFactor="8">
                        <xsl:value-of select="."/>
                    </Index:field>
                </xsl:for-each>
                ...
                <xsl:for-each select="mc:datafield[@tag='860']">
                    <Index:field Index:repeat="true" Index:name="title" Index:navn="titel" Index:type="token"  Index:suggest="true" Index:boostFactor="4">
                ...
                <xsl:for-each select="mc:datafield[@tag='863']" >
                    <Index:field Index:repeat="true" Index:name="title" Index:navn="titel"  Index:suggest="true" Index:type="token" Index:boostFactor="4">
                        <xsl:for-each select="mc:subfield[@code='t']">
                            <xsl:value-of select="."/>
                        </xsl:for-each>
                        <xsl:for-each select="mc:subfield[@code='c']">
