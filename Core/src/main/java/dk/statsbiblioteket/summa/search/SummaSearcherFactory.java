...
public class SummaSearcherFactory {
     ...
     *
     * @param conf         the configuration used to look up {@link SummaSearcher#CONF_CLASS}.
     * @param defaultClass the class to instantiate if {@link SummaSearcher#CONF_CLASS} is not set in {@code conf}.
     * @return a newly created {@code SummaSearcher}
     * @throws Configurable.ConfigurationException if there is an error reading {@code conf} or there is an error
     * creating the searcher instance.
     */
    public static SummaSearcher createSearcher(Configuration conf, Class<? extends SummaSearcher> defaultClass) {
    ...
    /**
     * Call {@link #createSearcher(Configuration, Class)} with the default class set to {@link SummaSearcherImpl}.
     *
