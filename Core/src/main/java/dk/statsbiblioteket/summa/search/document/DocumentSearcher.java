...
public interface DocumentSearcher extends SearchNode, DocumentKeys {
     ...
     */
    public static final String CONF_DEFAULT_SORTKEY = "summa.search.defaultsortkey";
    ...
    public static final String[] DEFAULT_RESULT_FIELDS = "recordID recordBase shortformat".split(" ");
     ...
     */
    public static final String CONF_FALLBACK_VALUES = "summa.search.fallbackvalues";
     ...
     */
    public static final String CONF_NONESCAPED_FIELDS = "summa.search.nonescapedfields";
     ...
     */
    public static final String CONF_COLLECT_DOCIDS = "summa.search.collectdocids";
     ...
     * @see #CONF_FALLBACK_VALUES
     */
    public void setFallbackValues(String[] fallbackValues) throws RemoteException;
