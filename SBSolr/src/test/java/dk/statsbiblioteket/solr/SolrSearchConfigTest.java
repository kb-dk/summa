...
public class SolrSearchConfigTest {
    ...
    String solrWarPath = "summa-sbsolr-1.8.0-20120529-trunk-SNAPSHOT.war";
    //String solrWarPath="/home/te/projects/summa-trunk/SBSolr/target/summa-sbsolr-1.8.0-20120529-trunk-SNAPSHOT.war";


    //String solrHome = "src/test/tomcat/solr"; //data-dir (index) will be created here.
    String solrHome = "/home/te/projects/summa-trunk/SBSolr/src/test/tomcat/solr"; //data-dir (index) will be created here.
    String context = "/solr";
    int port = 8983;
