...
public class BitsArrayPerformanceTest extends TestCase {
    ...
    public void testPerformance() throws Exception {
        int[] actionCounts = new int[]{100*1000, 1000*1000, 10*1000*1000};
        int[] lengths =      new int[]{1000, 100*1000, 1000*1000, 10*1000*1000};
        int[] valueMaxs =    new int[]{1, 15, 255, 256, 65535, 65536, 2097151,
                                       2147483646}; // 2^31-2 (Random-limit)
        ACTION[] actions = new ACTION[]{ACTION.write, ACTION.read};
        List<BitsArrayTest.BitsArrayGenerator> bags =
                new ArrayList<BitsArrayTest.BitsArrayGenerator>(
                        BitsArrayTest.getGenerators());
    ...
    public void testPerformance(
            List<BitsArrayTest.BitsArrayGenerator> bags, ACTION action,
        ...
        for (int i = 0 ; i < WARMUP ; i++) {
            for (BitsArrayTest.BitsArrayGenerator bag: bags) {
    ...
    public long measureActionPerformance(
            BitsArrayTest.BitsArrayGenerator bag, ACTION action,
            int initialLength, int initialValueMax,
    ...
    public BitsArray createAndFillBitsArray(
            BitsArrayTest.BitsArrayGenerator bag,
            int initialLength, int initialValueMax,
    ...
    public static List<String> getArrayNames(List<BitsArrayTest.BitsArrayGenerator> bags) {
    ...
    private class SignalBAG implements BitsArrayTest.BitsArrayGenerator {
