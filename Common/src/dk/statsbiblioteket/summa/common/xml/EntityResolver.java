...
public class EntityResolver implements EntityResolver2 {
    private static Log log = LogFactory.getLog(EntityResolver.class);
    ...
    public EntityResolver(Configuration conf) {
        this(conf, null);
    }
     ...
     *                  If null, this argument is ignored.
     */
    public EntityResolver(Configuration conf, Map<String, String> resources) {
        ...
        log.debug(String.format(
                "Finished creating EntityResolver with %d resources",
                this.resources.size()));
        if (this.resources.size() == 0) {
            log.warn("No resources specified for the EntityResolver");
        }
    }
