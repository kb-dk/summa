...
@QAInfo(level = QAInfo.Level.NORMAL,
        ...
        author = "te")
public class RelativesFilter extends AbstractDiscardFilter {
    private static Log log = LogFactory.getLog(RelativesFilter.class);
    ...
    public RelativesFilter(Configuration conf) {
        super(conf);
        discardHasParent =
