/* $Id: IndexField.java,v 1.5 2007/10/04 13:28:19 te Exp $
 * $Revision: 1.5 $
...
@QAInfo(level = QAInfo.Level.NORMAL,
        ...
        author = "hal")
public class IndexField implements Comparable {
    ...
    public static final class Alias implements Comparable {
        ...
        public int compareTo(Object o) {
            ...
            IndexField.Alias that = (IndexField.Alias) o;
            int compare;
            if (this.name != null) {
                if (that.name == null) {
                    return -1;
     ...
     */
    public IndexField(IndexDefaults def) {
     ...
     *  in the alias {@link dk.statsbiblioteket.summa.common.lucene.index.IndexField.Alias}.
     *
     ...
     *
     * @return a list of {@link dk.statsbiblioteket.summa.common.lucene.index.IndexField.Alias}.
     */
