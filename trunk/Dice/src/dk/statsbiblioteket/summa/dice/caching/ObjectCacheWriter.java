/* $Id: ObjectCacheWriter.java,v 1.2 2007/10/04 13:28:17 te Exp $
 * $Revision: 1.2 $
...
/**
 * Simple implementation of a {@link CacheWriter} writing java objects
 * to uncompressed data files.
 */
@QAInfo(level = QAInfo.Level.NORMAL,
        state = QAInfo.State.IN_DEVELOPMENT,
        author = "mke",
        comment = "Needs javadocs")
public class ObjectCacheWriter<E> implements CacheWriter<E> {
