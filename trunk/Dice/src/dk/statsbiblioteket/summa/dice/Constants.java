...
public interface Constants {
    ...
    public static final String EMPLOYER_CLASS = "employer.class";
    ...
    public static final String WORKER_CLASS = "worker.class";
    ...
    public static final String EMPLOYER_HOSTNAME = "employer.hostname";

    /** Hostname for the machine on which the Consumer is running */
    public static final String CONSUMER_HOSTNAME = "consumer.hostname";

    /** RMI service name for the Employer */
    public static final String EMPLOYER_SERVICE = "employer.service";
    ...
    public static final String EMPLOYER_PORT = "employer.port";

    /** Port on which the Consumer talks RMI */
    public static final String CONSUMER_PORT = "consumer.port";
    ...
    public static final String EMPLOYER_QUEUE_SIZE = "employer.queue";

    /** Number of jobs pending on the consumer before blocking */
    public static final String CONSUMER_QUEUE_SIZE = "consumer.queue";

    /** Number of jobs to prefetch on the Worker */
    public static final String WORKER_QUEUE_SIZE = "worker.queue";
    ...
    public static final String WORKER_ROLE = "worker.role";

    /** A place for the Employer to store data */
    public static final String EMPLOYER_DATA_PATH = "employer.data.path";

    /** A place for the Consumer to store data, this would typically be the final
     * data */
    public static final String CONSUMER_DATA_PATH = "consumer.data.path";

    /** A place for the Worker to store data, this would typically be intermediate
     * output of job processing  */
    public static final String WORKER_DATA_PATH = "worker.data.path";
    ...
    public static final String EMPLOYER_CACHE_SERVICE = "employer.cache.service";

    /** RMI service name for the Consumers {@link RemoteCache} */
    public static final String CONSUMER_CACHE_SERVICE = "consumer.cache.service";

    /** Port on which the Employers cache talks RMI */
    public static final String EMPLOYER_CACHE_PORT = "employer.cache.port";

    /** Port on which the Consumers cache talks RMI */
    public static final String CONSUMER_CACHE_PORT = "consumer.cache.port";

    /** Path to store cached items on the Employer.
     * Defaults to {@link #EMPLOYER_DATA_PATH}/cache */
    public static final String EMPLOYER_CACHE_PATH = "employer.cache.path";

    /** Path to store cached items on the Consumer.
     * Defaults to {@link #CONSUMER_DATA_PATH}/cache */
    public static final String CONSUMER_CACHE_PATH = "consumer.cache.path";

    /** Path to store cached items on the Worker.
     * Defaults to {@link #WORKER_DATA_PATH}/cache */
    public static final String WORKER_CACHE_PATH = "worker.cache.path";

    /** {@link CacheWriter} for writing to the Workers cache */
    public static final String WORKER_CACHE_WRITER = "worker.cache.writer";

    /** {@link CacheWriter} for writing to the Employers cache */
    public static final String EMPLOYER_CACHE_WRITER = "employer.cache.writer";

    /** {@link CacheWriter} for writing to the Consumers cache */
    public static final String CONSUMER_CACHE_WRITER = "consumer.cache.writer";

    /** {@link CacheReader} for reading from the Workers cache */
    public static final String WORKER_CACHE_READER = "worker.cache.reader";

    /** {@link CacheReader} for reading from the Employers cache */
    public static final String EMPLOYER_CACHE_READER = "employer.cache.reader";

    /** {@link CacheReader} for reading from the Consumers cache */
    public static final String CONSUMER_CACHE_READER = "consumer.cache.reader";
     ...
     * of a cached job */
    public static final String JOB_CACHE_ID = "job.cache.id";
