/* $Id: FacetBrowser.java,v 1.11 2007/10/05 10:20:24 te Exp $
 * $Revision: 1.11 $
 ...
 * CVS:  $Id: FacetBrowser.java,v 1.11 2007/10/05 10:20:24 te Exp $
 */
...
@QAInfo(level = QAInfo.Level.NORMAL,
        ...
        author = "te")
public class FacetBrowser implements IndexChangeListener { // implements Browser, Builder, FacetCore {
    private static Logger log = Logger.getLogger(FacetBrowser.class);
     ...
     */
    public FacetBrowser(Configuration configuration) throws IOException {
...
//        coreMap = CoreMapFactory.getCoreMap(configuration, connector);
    ...
    public void indexChanged(IndexChangeEvent event) {
        if (log.isDebugEnabled()) {
            log.debug("Index changed event catched in FacetBrowser: " + event);
        }
    }
}
