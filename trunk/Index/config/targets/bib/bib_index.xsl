...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="bib_short_format.xsl" />
    <xsl:include href="bib_author.xsl" />
    <xsl:include href="bib_title.xsl" />
    <xsl:include href="bib_subject.xsl" />
    <xsl:include href="bib_publisher.xsl" />
    <xsl:include href="bib_other.xsl" />
    <xsl:include href="bib_notes.xsl" />
    <xsl:include href="bib_identifiers.xsl" />
    <xsl:include href="bib_material.xsl" />
    <xsl:include href="bib_lma.xsl" />
