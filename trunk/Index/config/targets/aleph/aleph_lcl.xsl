    ...
    <xsl:template name="lcl">
        <Index:group Index:suggest="true" Index:navn="lcl" Index:name="lcl">
            ...
            <xsl:for-each select="mc:datafield[@tag='080']">
                ...
                </Index:field><Index:field Index:repeat="false" Index:name="lcl_all" Index:navn="lcl_all" Index:type="keyword" Index:boostFactor="10">
                <xsl:for-each select="mc:subfield[@code='a']">
                    <xsl:value-of select="."/>
                </xsl:for-each>
            </Index:field>
            ...
            <xsl:for-each select="mc:datafield[@tag='082' or @tag='089']">
                ...
                <Index:field Index:repeat="false" Index:name="lcl_all" Index:navn="lddc" Index:type="keyword" Index:boostFactor="10">
                    <xsl:for-each select="mc:subfield[@code='a']">
                        <xsl:value-of select="."/>
                    </xsl:for-each>
                    <xsl:for-each select="mc:subfield[@code='b']">
            ...
            <xsl:for-each select="mc:datafield[@tag='V03']/mc:subfield[@code='a']">
                ...
                <Index:field Index:repeat="true" Index:name="lcl_all" Index:navn="lcl_all" Index:type="keyword" Index:boostFactor="10">
                    <xsl:text>Mat </xsl:text>
                    <xsl:value-of select="."/>


                </Index:field>
                <Index:field Index:repeat="true" Index:name="lkl" Index:navn="lkl" Index:type="keyword" Index:boostFactor="10">
                    <xsl:text>Mat </xsl:text>
                    <xsl:value-of select="."/>
