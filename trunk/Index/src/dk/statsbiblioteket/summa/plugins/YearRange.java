...
public class YearRange {
     ...
     * The input needs to have <code>in.lenght() == 4</code> and may contain one
     * or two tailing <code>?</code><br>
     * if the input does not meet theese conditions the input is returned
     * unchanged.
     *
