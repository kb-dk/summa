...
public class ResultSetCursor implements ConnectionCursor {
    ...
    public ResultSetCursor(
            DatabaseStorage db, PreparedStatement stmt, ResultSet resultSet) throws SQLException, IOException {
     ...
     * @throws IOException  on any IOExceptions reading records.
     */
    public ResultSetCursor(DatabaseStorage db, PreparedStatement stmt, ResultSet resultSet, boolean anonymous)
    ...
    private Record nextValidRecord() throws SQLException, IOException {
        ...
        Record r = db.scanRecord(resultSet, this, options);
        ...
        while (resultSetHasNext && !options.allowsRecord(r)) {
            r = db.scanRecord(resultSet, this, options);
    ...
    /**
     * Called from
     * {@link DatabaseStorage#scanRecord(java.sql.ResultSet, ResultSetCursor, QueryOptions)}.
     *
