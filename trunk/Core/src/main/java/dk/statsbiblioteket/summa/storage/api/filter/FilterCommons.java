...
public class FilterCommons {
     ...
     */
    public static synchronized ConnectionContext<Storage> getAccess(Configuration conf, String accessKey) {
        //noinspection DuplicateStringLiteralInspection
        log.trace("getAccess(..., " + accessKey + ") called");
        String accessPoint;
        accessPoint = conf.getString(accessKey, "//localhost:28000/summa-storage");
     ...
     */
    public static synchronized void releaseAccess(ConnectionContext<Storage> context) {
     ...
     */
    public static void reportError(ConnectionContext<Storage> context, Throwable t) {
     ...
     */
    public static void reportError(ConnectionContext<Storage> context, String msg) {
