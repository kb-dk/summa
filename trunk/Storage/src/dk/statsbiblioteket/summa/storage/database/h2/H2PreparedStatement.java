 ...
 * connection of the statement when the H2PreparedStatement is closed.
 * <p/>
 * This is used to get connection pooling working together with
 * PreparedStatements for H2.
 */
public class H2PreparedStatement implements PreparedStatement {

    private PreparedStatement stmt;

    H2PreparedStatement (PreparedStatement stmt) {
        if (stmt instanceof H2PreparedStatement) {
            throw new IllegalArgumentException("Nested H2PreparedStatement "
