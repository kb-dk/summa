/* $Id: SetupServices.java,v 1.3 2007/10/11 12:56:24 te Exp $
 * $Revision: 1.3 $
 ...
 * CVS:  $Id: SetupServices.java,v 1.3 2007/10/11 12:56:24 te Exp $
 */
...
public class SetupServices {
    public static final File TESTDIR
            = new File("Score/test/dk/statsbiblioteket/summa/score/rmid")
            .getAbsoluteFile();
...
//    	String LOCATION = "file:/home/rmi_tutorial/activation/";
        ...
        ActivationDesc desc = new ActivationDesc(agi,
                         "dk.statsbiblioteket.summa.score.rmid.RemoteHelloImpl",
                         "file:" + LOCATION, data);
