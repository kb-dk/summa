/* $Id: Service.java,v 1.14 2007/10/11 12:56:25 te Exp $
 * $Revision: 1.14 $
...
// FIXME : Do we need a way to tell the service's JVM to exit
    /**
     * Stop the service. After the service has stopped, calling {@link #start()}
     * should reinitialise the service, based on the configuration.
     *
     * @throws RemoteException if there is an error communicating with the
     *                         service.
     */
