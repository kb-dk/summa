/* $Id: TestConfig.java,v 1.3 2007/10/04 13:28:20 te Exp $
 * $Revision: 1.3 $
 ...
 */
public class TestConfig extends Config implements Constants {

    public TestConfig () {
        super();
        setDefaults();

        setEmployerClass(TestEmployer.class);
        setConsumerClass(TestConsumer.class);
        setWorkerClass(TestWorker.class);
