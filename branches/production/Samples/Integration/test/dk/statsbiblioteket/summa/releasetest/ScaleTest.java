...
//        ReleaseTestCommon.tearDown();
    ...
    private Configuration getConfiguration() throws Exception {
        Configuration conf =
                Configuration.load("resources/scale/scale_configuration.xml");
        ...
        filters.get(0).set(RecordGenerator.CONF_CONTENT_TEMPLATE_LOCATION,
                           Resolver.getFile("resources/scale/fagref_template.xml").
                                   getAbsolutePath());

        // Fagref-XSLT
        String xsltLocation =
                Resolver.getURL("resources/scale/xslt/fagref_index.xsl").getFile();
        ...
        String descriptorLocation = Resolver.getURL(
                "resources/scale/scale_index_descriptor.xml").getFile();
