...
#JAVA_OPTS
JAVA_OPTS="-server -Xmx3200m -Xms512m -Dcom.sun.management.jmxremote"
...
#CODE_BASE
CODE_BASE=http://developer.statsbiblioteket.dk/remoteStubs/PostgresStorageStub.jar

$JAVA_HOME/bin/java -jar $JAVA_OPTS -Dsun.rmi.transport.tcp.connectionPool=true -Djava.rmi.server.codebase=$CODE_BASE -Djava.security.policy=$SECURITY_POLICY $JMX_PORT $JMX_SSL $JMX_ACCESS $JMX_PASS summaIndex.jar update &
